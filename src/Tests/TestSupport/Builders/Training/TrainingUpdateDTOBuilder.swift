//
//  TrainingUpdateDTOBuilder.swift
//  Backend
//
...
final class TrainingUpdateDTOBuilder {
    ...
    func build() -> TrainingUpdateDTO {
        TrainingUpdateDTO(date: date, roomId: roomId, trainerId: trainerId)
    }
}

//
//  MembershipTypeCreateDTOBuilder.swift
//  Backend
//
...
public final class MembershipTypeCreateDTOBuilder {
    ...
    public func build() -> MembershipTypeCreateDTO {
        return MembershipTypeCreateDTO(
            name: name,
            price: price,
            sessions: sessions,
            days: days
